...
def get_extensions():
    ...
    rs_type_include = os.path.join(os.path.dirname(__file__), "rs_type/include")        # 自定义点类型头文件
    rs_reader_include = os.path.join(os.path.dirname(__file__), "rs_reader/include")    # LiDAR读取器头文件

    # 源文件列表
    sources = [
        os.path.join(os.path.dirname(__file__), "rs_reader/src/LidarReader.cpp"),  # C++核心读取逻辑
